...
const COLLECTION_METHODS = [
  ...
  },
  {
    ...
    detail: "(filter?) -> number",
    insertText: "countDocuments({$1})",
    documentation: "Returns the count of documents that match the query.",
  },
  {
    label: "distinct",
    detail: "(field, filter?) -> Array",
    insertText: 'distinct("$1")',
    documentation: "Finds the distinct values for a specified field.",
  },
  {
    label: "createIndex",
    detail: "(keys, options?) -> string",
    insertText: "createIndex({ $1: 1 })",
    documentation: "Creates an index on the specified field(s).",
  },
  {
    label: "dropIndex",
    detail: "(name) -> void",
    insertText: 'dropIndex("$1")',
  ...
  },
  {
    ...
    documentation: "Returns an array of documents that describe the existing indexes.",
  },
  {
    label: "drop",
    detail: "() -> boolean",
    insertText: "drop()",
    documentation: "Removes a collection or view from the database.",
  },
  {
    label: "stats",
    detail: "() -> Object",
  ...
  {
    label: "replaceOne",
    detail: "(filter, replacement) -> UpdateResult",
    insertText: "replaceOne(\n  { $1 },\n  { $2 }\n)",
    documentation: "Replaces a single document within the collection.",
  },
  {
    label: "bulkWrite",
    detail: "(operations) -> BulkWriteResult",
    insertText: "bulkWrite([\n  $1\n])",
...
const QUERY_OPERATORS = [
  ...
  },
  {
    ...
    detail: "BSON type",
    insertText: '\\$type: "$1"',
    documentation: "Selects documents with a specific field type.",
  },
  // Evaluation
  {
    label: "$regex",
    ...
    insertText: '\\$regex: "$1"',
    documentation: "Selects documents matching a regular expression.",
  },
  {
    label: "$text",
    detail: "Text search",
    insertText: '\\$text: { \\$search: "$1" }',
    documentation: "Performs text search.",
  },
  // Array
  {
    label: "$all",
    detail: "All elements match",
    insertText: "\\$all: [$1]",
    documentation: "Matches arrays containing all specified elements.",
  },
  {
    label: "$elemMatch",
    detail: "Element match",
    insertText: "\\$elemMatch: { $1 }",
    documentation: "Selects documents with array element matching conditions.",
  },
  {
    label: "$size",
    detail: "Array size",
    insertText: "\\$size: $1",
    documentation: "Selects documents with array of specified size.",
  },
  // Update
  {
    label: "$set",
    ...
    insertText: "\\$set: { $1 }",
    documentation: "Sets the value of a field.",
  },
  {
    label: "$unset",
    detail: "Remove field",
  ...
  },
  {
    ...
    detail: "Increment",
    insertText: "\\$inc: { $1: 1 }",
    documentation: "Increments the value of a field by a specified amount.",
  },
  {
    label: "$push",
    detail: "Push to array",
    insertText: "\\$push: { $1 }",
    documentation: "Adds an element to an array.",
  },
  {
    label: "$pull",
    detail: "Pull from array",
    insertText: "\\$pull: { $1 }",
    documentation: "Removes all array elements matching a condition.",
  },
  {
    label: "$addToSet",
    detail: "Add to set",
    insertText: "\\$addToSet: { $1 }",
    documentation: "Adds elements to array only if they don't already exist.",
  },
  // Aggregation stages
  {
    label: "$match",
    ...
    insertText: "\\$match: { $1 }",
    documentation: "Filters the documents to pass only matching documents.",
  },
  {
    label: "$group",
    detail: "Group by expression",
    insertText: "\\$group: {\n  _id: $1,\n}",
    documentation: "Groups input documents by a specified expression.",
  },
  {
    label: "$sort",
    detail: "Sort documents",
    insertText: "\\$sort: { $1: 1 }",
  ...
  },
  {
    ...
    insertText: "\\$limit: $1",
    documentation: "Limits the number of documents.",
  },
  {
    label: "$skip",
    detail: "Skip documents",
    insertText: "\\$skip: $1",
    documentation: "Skips a specified number of documents.",
  },
  {
    label: "$project",
    detail: "Reshape documents",
    insertText: "\\$project: {\n  $1\n}",
    documentation: "Reshapes each document in the stream.",
  },
  {
    label: "$unwind",
    detail: "Deconstruct array",
    insertText: '\\$unwind: "\\$$1"',
    documentation: "Deconstructs an array field from input documents.",
  },
  {
    label: "$lookup",
  ...
  },
  {
    ...
    insertText: '\\$count: "$1"',
    documentation: "Returns a count of documents at this stage.",
  },
  {
    label: "$sample",
    detail: "Random sample",
    insertText: "\\$sample: { size: $1 }",
    documentation: "Randomly selects the specified number of documents.",
  },
  {
    label: "$merge",
    detail: "Merge into collection",
    insertText: '\\$merge: { into: "$1" }',
    documentation: "Writes the results to a specified collection.",
  },
  {
    label: "$out",
    detail: "Output to collection",
    insertText: '\\$out: "$1"',
    documentation: "Writes the results to a collection.",
  },
];
...
const BSON_CONSTRUCTORS = [
  { label: "ObjectId", insertText: 'ObjectId("$1")', documentation: "Creates a new ObjectId." },
  {
    ...
    documentation: "Creates a date object. Accepts ISO 8601 date string.",
  },
  ...
  { label: "NumberInt", insertText: "NumberInt($1)", documentation: "Creates a 32-bit integer." },
  {
    ...
    documentation: "Creates a 128-bit decimal.",
  },
